...
@Deprecated
public class SrvInteractivePackage<M extends PackageUml, DRI, SD extends ISettingsDraw, DLI> 
    extends SrvInteractiveShapeUml<M, DRI, SD> {

  private final IFactoryEditorElementUml<M, DLI> factoryEditorElementUml;
  
  public SrvInteractivePackage(SrvGraphicPackage<M, DRI, SD> srvGraphicShape, 
