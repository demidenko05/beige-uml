...
public class NodeDiagramObject extends NodeFolderProject {
  
  private final IControllerMainUml<FileAndWriter> controllerMainUml;

  public NodeDiagramObject(String path, String name, IControllerMainUml<FileAndWriter> controllerMainUml) {
    super(path, name);
  ...
  public void open() {
    ...
    pi.setFile(file);
    controllerMainUml.openDiagramObject(pi);
  }
}
