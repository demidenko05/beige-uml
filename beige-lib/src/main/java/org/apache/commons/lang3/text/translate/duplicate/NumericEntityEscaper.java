 ...
 */
package org.apache.commons.lang3.text.translate.duplicate;
...
public class NumericEntityEscaper extends CodePointTranslator {
     ...
     */
    public NumericEntityEscaper below(final int codepoint) {
     ...
     * @return the newly created {@code NumericEntityEscaper} instance
     */
    public NumericEntityEscaper above(final int codepoint) {
     ...
     * @return the newly created {@code NumericEntityEscaper} instance
     */
    public NumericEntityEscaper outsideOf(final int codepointLow, final int codepointHigh) {
